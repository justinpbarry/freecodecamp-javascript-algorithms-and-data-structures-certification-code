...
// the title and rating from watchList and save the new array in the rating variable. The
// code in the editor currently uses a for loop to do this, replace the loop functionality
...
rating = watchList.map(function(element) {
